...
public class SudokuSolver {
				...
				for (int y = x + 1; y < arr.length; y++) {
					...
					if (counter == 2) {
						...
						if (p[row][col].contains(first) && p[row][col].contains(second)
							...
							/*
							 * if (foundCol == 10) { System.out.println("foundCol="+foundCol); }
							 */
							if (p[row][col].size() > 2) {
								p[row][col].clear();
								p[row][col].add(first);
	...
	private void solveByDoubleBoxRow(int row) {
		...
		for (int k = 0; k < boxP.size(); k++) {
			...
			for (int boxJ = 0; boxJ < 3; boxJ++) {
				for (int i = boxI; i < (boxI + 3); i++) {
					if (p[i][(3 * boxJ)].contains(pr) || p[i][((3 * boxJ) + 1)].contains(pr)
							|| p[i][((3 * boxJ) + 2)].contains(pr)) {
						boxFoundRow[i % 3][boxJ] = i;
					}
				}
			}

			if (boxFoundRow[0][0] == boxFoundRow[1][0] && boxFoundRow[0][1] == boxFoundRow[1][1]
					&& boxFoundRow[0][2] == boxFoundRow[1][2]) {
			...
			} else if (boxFoundRow[2][0] == boxFoundRow[1][0] && boxFoundRow[2][1] == boxFoundRow[1][1]
					&& boxFoundRow[2][2] == boxFoundRow[1][2]) {
			...
			} else if (boxFoundRow[0][0] == boxFoundRow[2][0] && boxFoundRow[0][1] == boxFoundRow[2][1]
					&& boxFoundRow[0][2] == boxFoundRow[2][2]) {
				if (boxFoundRow[0][0] == null && boxFoundRow[0][1] != null && boxFoundRow[0][2] != null) {
	...
	private void solveByDoubleBoxCol(int col) {
		...
		for (int k = 0; k < boxP.size(); k++) {
			...
			for (int boxI = 0; boxI < 3; boxI++) {
				for (int j = boxJ; j < (boxJ + 3); j++) {
					if (p[(3 * boxI)][j].contains(pr) || p[((3 * boxI) + 1)][j].contains(pr)
							|| p[((3 * boxI) + 2)][j].contains(pr)) {
						boxFoundCol[boxI][j % 3] = j;
					}
				}
			}

			if (boxFoundCol[0][0] == boxFoundCol[1][0] && boxFoundCol[0][1] == boxFoundCol[1][1]
					&& boxFoundCol[0][2] == boxFoundCol[1][2]) {
			...
			} else if (boxFoundCol[2][0] == boxFoundCol[1][0] && boxFoundCol[2][1] == boxFoundCol[1][1]
					&& boxFoundCol[2][2] == boxFoundCol[1][2]) {
			...
			} else if (boxFoundCol[0][0] == boxFoundCol[2][0] && boxFoundCol[0][1] == boxFoundCol[2][1]
					&& boxFoundCol[0][2] == boxFoundCol[2][2]) {
				if (boxFoundCol[0][0] == null && boxFoundCol[0][1] != null && boxFoundCol[0][2] != null) {
	...
	private void printDups(int i, int j, int k, int l) {
		System.err
				.println("Duplicate value " + a[i][j] + " found for a[" + i + "][" + j + "] & a[" + k + "][" + l + "]");
	}
	...
	private void setTestProbables() {
		Integer p00[] = { 3, 4, 7, 8, 9 };
		Integer p01[] = { 3, 4, 7, 9 };
		Integer p02[] = {};
		Integer p03[] = { 2, 4, 7, 9 };
		Integer p04[] = { 2, 3, 4, 5, 9 };
		Integer p05[] = { 2, 3, 5, 7, 9 };
		Integer p06[] = {};
		Integer p07[] = { 4, 8, 9 };
		Integer p08[] = { 4, 5, 7, 8 };
		Integer p10[] = { 4, 7, 9 };
		...
		Integer p44[] = {};
		Integer p45[] = { 2, 5, 9 };
		Integer p46[] = { 2, 4, 6, 8, 9 };
		Integer p47[] = { 1, 4, 6, 8, 9 };
		Integer p48[] = { 1, 3, 4, 6, 8 };
		Integer p50[] = { 3, 4, 7, 9 };
		Integer p51[] = {};
		Integer p52[] = { 3, 7, 9 };
		Integer p53[] = {};
